...
import com.zabdieldev.arelanc.dto.ErrorDetalles;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(EmpleadosAppException.class)
    public ResponseEntity<ErrorDetalles> manejarEmpleadosAppException(EmpleadosAppException exception,
            WebRequest webRequest) {
        ErrorDetalles errorDetalles = new ErrorDetalles(new Date(), exception.getMessage(),
                webRequest.getDescription(false));
